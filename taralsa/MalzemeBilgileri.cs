...
namespace taralsa
{
    public partial class MalzemeBilgileri : Form
    {
        ...
        malzeme1 malz = new malzeme1();
        public void DataGridYenile()
        {
            dgwProducts2.DataSource = malz.TabloyuGetir();
        }

        public MalzemeBilgileri()
        {
            InitializeComponent();
            DataGridYenile();
        }
        ...
        {
            malz.YeniSatirEkle(textBox5.Text, textBox4.Text, textBox3.Text, textBox7.Text, textBox1.Text, textBox6.Text,textBox2.Text);
            DataGridYenile();
        }
        ...
        public void satirDegisti()
        {
            ...
            textBox2.Text = dgwProducts2.Rows[dgwProducts2.CurrentRow.Index].Cells[7].Value.ToString();
        }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            {
                string ID = dgwProducts2.Rows[dgwProducts2.CurrentRow.Index].Cells[0].Value.ToString();
                malz.SatirGunceleme(ID, textBox5.Text, textBox4.Text, textBox3.Text, textBox7.Text, textBox1.Text, textBox6.Text, textBox2.Text);
                DataGridYenile();
            }
            else
            {
        ...
        {
            conn.Open();
            SqlCommand command = new SqlCommand("Select * from MalzemeBilgileri Where MalzemeNo like'%" + textBox5.Text + "%'", conn);
            SqlDataAdapter dataAdapter = new SqlDataAdapter(command);
            DataSet data = new DataSet();
            dataAdapter.Fill(data, "MalzemeBilgileri");
            dgwProducts2.DataSource = data.Tables[0];
            conn.Close();
        }

        private void MalzemeBilgileri_Load(object sender, EventArgs e)
        {
